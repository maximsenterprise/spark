...
pub fn embed(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<embed{} src=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<embed{} src=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<embed{} style=\"{}\" src=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<embed{} src=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}