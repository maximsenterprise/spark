...
pub fn object(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<object{} data=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<object{} data=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<object{} style=\"{}\" data=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<object{} data=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}