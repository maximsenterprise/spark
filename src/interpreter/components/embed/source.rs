...
pub fn source(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<source{} src=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<source{} src=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<source{} style=\"{}\" src=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<source{} src=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}