...
pub fn track(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<track{} src=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<track{} src=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<track{} style=\"{}\" src=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<track{} src=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}