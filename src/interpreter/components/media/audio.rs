...
pub fn audio(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<audio{} src=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<audio{} src=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<audio{} style=\"{}\" src=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<audio{} src=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}