...
pub fn video(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<video{} src=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<video{} src=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<video{} style=\"{}\" src=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<video{} src=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}