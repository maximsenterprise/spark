...
pub fn area(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<area{} href=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<area{} href=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<area{} style=\"{}\" href=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<area{} href=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}