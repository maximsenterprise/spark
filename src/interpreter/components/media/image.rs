...
pub fn image(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<img{} src=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<img{} src=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<img{} style=\"{}\" src=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<img{} src=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}