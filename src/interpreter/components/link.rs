...
pub fn link(nodes: &mut Vec<Node>) -> String {
    ...
    if style == "" {
        if alias == "" {
            format!("<a{} href=\"{}\"></a>", arguments, content)
        }
        else {
            format!("<a{} href=\"{}\">{}</a>", arguments, content, alias)
        }
    }
    else {
        if alias == "" {
            format!("<a{} style=\"{}\" href=\"{}\"></a>", arguments, style, content)
        }
        else {
            format!("<a{} href=\"{}\" style=\"{}\">{}</a>", arguments, content, style, alias)
        }
    }
}